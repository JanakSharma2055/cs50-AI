...
class Sentence():
    ...
    def mark_mine(self, cell):
        ...
        """
        # if any cell is found to be mine then it must be removed from sentence
        # also count must be decreased as it has been classified as a mine
    ...
    def mark_safe(self, cell):
        ...
        """
        # here no need to decrease count because self.count tracks no of
        # mines not the safe cells
...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        neighbors, count = self.get_neighbors_cell(cell, count)
        ...
        for sentence in self.knowledge:
            ...
            if safe is not None:
                for cell in list(safe):
                    self.mark_safe(cell)
            if mine is not None:
                for cell in list(mine):
                    self.mark_mine(cell)

        # new sentences are inferred using the subset method
        # the sentences are taken as a group of two sentences
        # and the inferences is made
    ...
    def make_random_move(self):
        ...
        if total_moves:
            return random.choice(total_moves)
        else:
            return None

    def get_neighbors_cell(self, cell, count):
        neighbors = []
